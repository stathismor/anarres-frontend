      ...
      <info-card>
        <p class="card-text">
          <translate key="lang_card_info"
            >Create custom fields to store extra metadata about each media file
            uploaded to your station libraries.</translate
          >
        </p>
      </info-card>
      ...
      fields: [
        {
          key: 'name',
          isRowHeader: true,
          label: this.$gettext('Field Name'),
          sortable: false,
        },
        {
          key: 'auto_assign',
          label: this.$gettext('Auto-Assign Value'),
          sortable: false,
        },
        {
          key: 'actions',
