      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Note: This should be the public-facing homepage of the radio
              station, not the AzuraCast URL. It will be included in broadcast
              details.</translate
            >
          </template>
        </b-wrapped-form-group>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Scheduled playlists and other timed items will be controlled by
              this time zone.</translate
            >
          </template>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >If a song has no album art, this URL will be listed instead.
              Leave blank to use the standard placeholder art.</translate
            >
          </template>
        </b-wrapped-form-group>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Optionally specify a short URL-friendly name, such as
              "my_station_name", that will be used in this station's URLs. Leave
              this field blank to automatically create one based on the station
              name.</translate
            >
          </template>
        </b-wrapped-form-group>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Customize the number of songs that will appear in the "Song
              History" section for this station and in all public
              APIs.</translate
            >
          </template>
          <template #default="props">
    ...
    <b-form-fieldset>
      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Show the station in public pages and general API
              results.</translate
            >
          </template>
        </b-wrapped-form-checkbox>
    ...
    <b-form-fieldset>
      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >If enabled, music from playlists with on-demand streaming enabled
              will be available to stream via a specialized public
              page.</translate
            >
          </template>
        </b-wrapped-form-checkbox>
        ...
        >
          <template #label="{ lang }">
            <translate :key="lang"
              >Enable Downloads on On-Demand Page</translate
            >
          </template>
          <template #description="{ lang }">
            <translate :key="lang"
              >If enabled, a download button will also be present on the public
              "On-Demand" page.</translate
            >
          </template>
        </b-wrapped-form-checkbox>
      </b-form-row>
