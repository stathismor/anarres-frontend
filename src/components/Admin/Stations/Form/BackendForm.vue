      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >This software shuffles from playlists of music constantly and
              plays when no other radio source is available.</translate
            >
          </template>
    ...
    <b-form-fieldset v-if="isBackendEnabled">
      <b-form-fieldset>
        <b-form-row>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >Choose a method to use when transitioning from one song to
                another. Smart Mode considers the volume of the two tracks when
                fading for a smoother effect, but requires more CPU
                resources.</translate
              >
            </template>
            <template #default="props">
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >Number of seconds to overlap songs.</translate
              >
            </template>
          </b-wrapped-form-group>
          ...
          >
            <template #label="{ lang }">
              <translate :key="lang"
                >Apply Compression and Normalization</translate
              >
            </template>
            <template #description="{ lang }">
              <translate :key="lang"
                >Compress and normalize your station's audio, producing a more
                uniform and "full" sound.</translate
              >
            </template>
          </b-wrapped-form-checkbox>
        </b-form-row>
      ...
      <b-form-fieldset>
        ...
        <template #description>
          <translate key="lang_song_requests_desc"
            >Some stream licensing providers may have specific rules regarding
            song requests. Check your local regulations for more
        ...
        <b-form-fieldset>
          <b-form-row>
            ...
            >
              ...
              <template #description="{ lang }">
                <translate :key="lang"
                  >Enable listeners to request a song for play on your station.
                  Only songs that are already in your playlists are
                  requestable.</translate
                >
              </template>
            </b-wrapped-form-checkbox>
          </b-form-row>
        ...
        <b-form-fieldset v-if="form.enable_requests.$model">
          <b-form-row>
            ...
            >
              <template #label="{ lang }">
                <translate :key="lang"
                  >Request Minimum Delay (Minutes)</translate
                >
              </template>
              <template #description="{ lang }">
                <translate :key="lang"
                  >If requests are enabled, this specifies the minimum delay (in
                  minutes) between a request being submitted and being played.
                  If set to zero, a minor delay of 15 seconds is applied to
                  prevent request floods.</translate
                >
              </template>
            </b-wrapped-form-group>
            ...
            >
              <template #label="{ lang }">
                <translate :key="lang"
                  >Request Last Played Threshold (Minutes)</translate
                >
              </template>
              <template #description="{ lang }">
                <translate :key="lang"
                  >This specifies the minimum time (in minutes) between a song
                  playing on the radio and being available to request again. Set
                  to 0 for no threshold.</translate
                >
              </template>
            </b-wrapped-form-group>
          </b-form-row>
        ...
        <b-form-fieldset>
          <b-form-row>
            ...
            >
              ...
              <template #description="{ lang }">
                <translate :key="lang"
                  >If enabled, streamers (or DJs) will be able to connect
                  directly to your stream and broadcast live music that
                  interrupts the AutoDJ stream.</translate
                >
              </template>
            </b-wrapped-form-checkbox>
          </b-form-row>
          ...
          <b-form-fieldset>
            <b-form-row>
              ...
              >
                ...
                <template #description="{ lang }">
                  <translate :key="lang"
                    >If enabled, AzuraCast will automatically record any live
                    broadcasts made to this station to per-broadcast
          ...
          <b-form-fieldset v-if="form.backend_config.record_streams.$model">
            <b-form-row>
              ...
              >
                <template #label="{ lang }">
                  <translate :key="lang"
                    >Live Broadcast Recording Format</translate
                  >
                </template>
              ...
              >
                <template #label="{ lang }">
                  <translate :key="lang"
                    >Live Broadcast Recording Bitrate (kbps)</translate
                  >
                </template>
          ...
          <b-form-fieldset>
            <b-form-row>
              ...
              >
                <template #label="{ lang }">
                  <translate :key="lang"
                    >Deactivate Streamer on Disconnect (Seconds)</translate
                  >
                </template>
                <template #description="{ lang }">
                  <translate :key="lang"
                    >This is the number of seconds until a streamer who has been
                    manually disconnected can reconnect to the stream. Set to 0
                    to allow the streamer to immediately reconnect.</translate
                  >
                </template>
              </b-wrapped-form-group>
              ...
              >
                ...
                <template #description="{ lang }">
                  <translate :key="lang"
                    >No other program can be using this port. Leave blank to
                    automatically assign a port.</translate
                  >
                  <br />
                  <translate :key="lang + '2'"
                    >Note: the port after this one will automatically be used
                    for legacy connections.</translate
                  >
                </template>
              </b-wrapped-form-group>
              ...
              >
                <template #label="{ lang }">
                  <translate :key="lang"
                    >DJ/Streamer Buffer Time (Seconds)</translate
                  >
                </template>
                <template #description="{ lang }">
                  <translate :key="lang"
                    >The number of seconds of signal to store in case of
                    interruption. Set to the lowest value that your DJs can use
                    without stream interruptions.</translate
                  >
                </template>
              </b-wrapped-form-group>
              ...
              >
                <template #label="{ lang }">
                  <translate :key="lang"
                    >Customize DJ/Streamer Mount Point</translate
                  >
                </template>
                <template #description="{ lang }">
                  <translate :key="lang"
                    >If your streaming software requires a specific mount point
                    path, specify it here. Otherwise, use the
                    default.</translate
                  >
                </template>
              </b-wrapped-form-group>
      ...
      <b-form-fieldset v-if="showAdvanced">
        ...
        <b-form-row>
          ...
          >
            <template #label="{ lang }">
              <translate :key="lang"
                >Customize Internal Request Processing Port</translate
              >
            </template>
            <template #description="{ lang }">
              <translate :key="lang"
                >This port is not used by any external process. Only modify this
                port if the assigned port is in use. Leave blank to
                automatically assign a port.</translate
              >
            </template>
          </b-wrapped-form-group>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >Instruct Liquidsoap to use any replaygain metadata associated
                with a song to control its volume level.</translate
              >
            </template>
          </b-wrapped-form-checkbox>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                ...
                automatically fill the queue.</translate
              >
            </template>
          </b-wrapped-form-group>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >This mode disables AzuraCast's AutoDJ management, using
                Liquidsoap itself to manage song playback. "Next Song" and some
                other features will not be available.</translate
              >
            </template>
          </b-wrapped-form-checkbox>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >For most cases, use the default UTF-8 encoding. The older
                ISO-8859-1 encoding can be used if accepting connections from
                SHOUTcast 1 DJs or using other legacy software.</translate
              >
            </template>
            <template #default="props">
              <b-form-radio-group
          ...
          >
            <template #label="{ lang }">
              <translate :key="lang"
                >Duplicate Prevention Time Range (Minutes)</translate
              >
            </template>
            <template #description="{ lang }">
              <translate :key="lang"
                >This specifies the time range (in minutes) of the song history
                that the duplicate song prevention algorithm should take into
                account.</translate
              >
            </template>
          </b-wrapped-form-group>
