<template>
  <b-tab :title="langTabTitle" :title-link-class="tabClass">
      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >This software delivers your broadcast to the listening
              audience.</translate
            >
          </template>
    ...
    <b-form-fieldset v-if="isLocalFrontend">
      ...
      <b-form-fieldset>
        <b-form-row>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >Leave blank to automatically generate a new
                password.</translate
              >
            </template>
          </b-wrapped-form-group>
          ...
          >
            <template #label="{ lang }">
              <translate :key="lang"
                >Customize Administrator Password</translate
              >
            </template>
            <template #description="{ lang }">
              <translate :key="lang"
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >Maximum number of total listeners across all streams. Leave
                blank to use the default.</translate
              >
            </template>
          </b-wrapped-form-group>
        </b-form-row>
        ...
        <b-form-row>
          <b-col md="5">
            ...
            >
              ...
              <template #description="{ lang }">
                <translate :key="lang"
                  >List one IP address or group (in CIDR format) per
                  line.</translate
                >
              </template>
            </b-wrapped-form-group>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >Select the countries that are not allowed to connect to the
                streams.</translate
              >
            </template>
            <template #default="props">
      ...
      <b-form-fieldset v-if="showAdvanced">
        <template #label>
          <translate key="lang_hdr_custom_config"
            >Custom Configuration</translate
          >
        </template>
        <template #description>
          <translate key="lang_custom_config_1"
            >This code will be included in the frontend configuration. Allowed
            formats are:</translate
          >
          <ul>
