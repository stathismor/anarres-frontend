        ...
        <b-form-row>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >If disabled, the station will not broadcast or shuffle its
                AutoDJ.</translate
              >
            </template>
          </b-wrapped-form-checkbox>
          ...
          >
            ...
            <template #description="{ lang }">
              <translate :key="lang"
                >The parent directory where station playlist and configuration
                files are stored. Leave blank to use default
                directory.</translate
              >
            </template>
          </b-wrapped-form-group>
        ...
        <b-overlay variant="card" :show="storageLocationsLoading">
          <b-form-row>
            ...
            >
              <template #label="{ lang }">
                <translate :key="lang"
                  >Live Recordings Storage Location</translate
                >
              </template>
              <template #default="props">
                <b-form-select
...
export default {
  ...
  methods: {
    loadLocations() {
      this.axios
        .get(this.storageLocationApiUrl)
        .then((resp) => {
