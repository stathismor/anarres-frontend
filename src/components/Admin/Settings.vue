      ...
      <b-overlay variant="card" :show="loading">
        <b-tabs card lazy justified>
          <settings-general-tab
            :form="$v.form"
            :tab-class="getTabClass($v.generalTab)"
          ></settings-general-tab>
          <settings-security-privacy-tab
            :form="$v.form"
            :tab-class="getTabClass($v.securityPrivacyTab)"
          ></settings-security-privacy-tab>
          <settings-services-tab
            :form="$v.form"
            :tab-class="getTabClass($v.servicesTab)"
...
export default {
  ...
  validations: {
    ...
    generalTab: [
      'form.base_url',
      'form.instance_name',
      'form.prefer_browser_url',
      'form.use_radio_proxy',
      'form.history_keep_days',
      'form.enable_websockets',
      'form.enable_advanced_features',
    ],
    securityPrivacyTab: [
      'form.analytics',
      'form.always_use_ssl',
      'form.api_access_control',
    ],
    servicesTab: [
      'form.check_for_updates',
      'form.mail_enabled',
      'form.mail_sender_name',
      'form.mail_sender_email',
      'form.mail_smtp_host',
      'form.mail_smtp_port',
      'form.mail_smtp_secure',
      'form.mail_smtp_username',
      'form.mail_smtp_password',
      'form.avatar_service',
      'form.avatar_default_url',
      'form.use_external_album_art_in_apis',
      'form.use_external_album_art_when_processing_media',
  ...
  methods: {
    ...
    populateForm(data) {
      this.form = {
        ...
        use_external_album_art_when_processing_media:
          data.use_external_album_art_when_processing_media,
