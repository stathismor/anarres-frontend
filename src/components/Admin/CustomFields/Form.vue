    ...
    <b-form-row>
      ...
      >
        ...
        <template #description="{ lang }">
          <translate :key="lang"
            >This will be used as the label when editing individual songs, and
            will show in API results.</translate
          >
        </template>
      </b-wrapped-form-group>
      ...
      >
        ...
        <template #description="{ lang }">
          <translate :key="lang"
            ...
            Leave this field blank to automatically create one based on the
            name.</translate
          >
        </template>
      </b-wrapped-form-group>
      ...
      >
        ...
        <template #description="{ lang }">
          <translate :key="lang"
            >Optionally select an ID3v2 metadata field that, if present, will be
            used to set this field's value.</translate
          >
        </template>
