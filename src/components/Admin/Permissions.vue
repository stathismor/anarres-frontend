      ...
      <info-card>
        <p class="card-text">
          <translate key="lang_card_info"
            >AzuraCast uses a role-based access control system. Roles are given
            permissions to certain sections of the site, then users are assigned
            into those roles.</translate
          >
        </p>
      </info-card>
      ...
      fields: [
        {
          key: 'name',
          isRowHeader: true,
          label: this.$gettext('Role Name'),
          sortable: true,
        },
        {
          key: 'permissions',
          label: this.$gettext('Permissions'),
          sortable: false,
        },
        {
          key: 'actions',
