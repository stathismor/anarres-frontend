  ...
  <form class="form vue-form" @submit.prevent="submit">
    <section class="card mb-3" role="region">
      <div class="card-header bg-primary-dark">
        <h2 class="card-title">
          <translate key="lang_header_branding_settings"
            >Branding Settings</translate
          >
        </h2>
      </div>
            ...
            <b-form-row>
              ...
              >
                ...
                <template #description="{ lang }">
                  <translate :key="lang"
                    >Select a theme to use as a base for station public pages
                    and the login page.</translate
                  >
                </template>
              ...
              <b-col md="6">
                ...
                >
                  <template #label="{ lang }">
                    <translate :key="lang"
                      >Hide Album Art on Public Pages</translate
                    >
                  </template>
                  <template #description="{ lang }">
                    <translate :key="lang"
                      >If selected, album art will not display on public-facing
                      radio pages.</translate
                    >
                  </template>
                </b-wrapped-form-checkbox>
                ...
                >
                  <template #label="{ lang }">
                    <translate :key="lang"
                      >Hide AzuraCast Branding on Public Pages</translate
                    >
                  </template>
                  <template #description="{ lang }">
                    <translate :key="lang"
                      >If selected, this will remove the AzuraCast branding from
                      public-facing pages.</translate
                    >
                  </template>
                </b-wrapped-form-checkbox>
              </b-col>
              ...
              >
                ...
                <template #description="{ lang }">
                  <translate :key="lang"
                    >If a visitor is not signed in and visits the AzuraCast
                    homepage, you can automatically redirect them to the URL
                    specified here. Leave blank to redirect them to the login
                    screen by default.</translate
                  >
                </template>
              </b-wrapped-form-group>
              ...
              >
                ...
                <template #description="{ lang }">
                  <translate :key="lang"
                    >If a song has no album art, this URL will be listed
                    instead. Leave blank to use the standard placeholder
                    art.</translate
                  >
                </template>
              </b-wrapped-form-group>
              ...
              >
                ...
                <template #description="{ lang }">
                  <translate :key="lang"
                    >This CSS will be applied to the station public pages and
              ...
              >
                ...
                <template #description="{ lang }">
                  <translate :key="lang"
                    >This javascript code will be applied to the station public
                    pages and login page.</translate
                  >
                </template>
                <template #default="props">
                  <codemirror-textarea
              ...
              >
                <template #label="{ lang }">
                  <translate :key="lang"
                    >Custom CSS for Internal Pages</translate
                  >
                </template>
                <template #description="{ lang }">
                  <translate :key="lang"
                    >This CSS will be applied to the main management pages, like
                    this one.</translate
                  >
                </template>
                <template #default="props">
