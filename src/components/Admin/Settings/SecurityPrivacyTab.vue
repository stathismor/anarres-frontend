      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Aggregate listener statistics are used to show station reports
              across the system. IP-based listener statistics are used to view
              live listener tracking and may be required for royalty
              reports.</translate
            >
          </template>
          <template #default="props">
            ...
            >
              <b-form-radio value="all">
                ...
                <translate key="analytics_opt_full_desc"
                  >Collect aggregate listener statistics and IP-based listener
                  statistics</translate
                >
              </b-form-radio>
              <b-form-radio value="no_ip">
                <b>
                  <translate key="analytics_opt_no_ip_title"
                    >Limited:</translate
                  >
                </b>
                <translate key="analytics_opt_no_ip_desc"
                  >Only collect aggregate listener statistics</translate
                >
              </b-form-radio>
              <b-form-radio value="none">
                ...
                <translate key="analytics_opt_none_desc"
                  >Do not collect any listener analytics</translate
                >
              </b-form-radio>
            </b-form-radio-group>
          </template>
    ...
    <b-form-fieldset>
      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Set to "Yes" to always use "https://" secure URLs, and to
              automatically redirect to the secure URL when an insecure URL is
              visited.</translate
            >
          </template>
        </b-wrapped-form-checkbox>
        ...
        >
          <template #label="{ lang }">
            <translate :key="lang"
              >API "Access-Control-Allow-Origin" Header</translate
            >
          </template>
          <template #description="{ lang }">
            <translate :key="lang"
              >Set to * to allow all sources, or specify a list of origins
            ...
            >
              <translate :key="lang + '2'"
                >Learn more about this header.</translate
              >
            </a>
          </template>
        </b-wrapped-form-group>
