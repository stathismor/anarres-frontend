      ...
      <b-form-row>
          ...
          <template #default="props">
            ...
            >
              <b-form-radio value="local">
                <translate key="lang_form_adapter_local"
                  >Local Filesystem</translate
                >
              </b-form-radio>
              <b-form-radio value="s3">
                <translate key="lang_form_adapter_s3"
                  >Remote: S3 Compatible</translate
                >
              </b-form-radio>
              <b-form-radio value="dropbox">
                <translate key="lang_form_adapter_dropbox"
                  >Remote: Dropbox</translate
                >
              </b-form-radio>
            </b-form-radio-group>
          </template>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >For local filesystems, this is the base path of the directory.
              For remote filesystems, this is the folder prefix.</translate
            >
          </template>
        </b-wrapped-form-group>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Set a maximum disk space that this storage location can use.
              Specify the size with unit, i.e. "8 GB". Units are measured in
              1024 bytes. Leave blank to default to the available space on the
              disk.</translate
            >
          </template>
        </b-wrapped-form-group>
        ...
        <b-form-group>
          <b-form-row>
            ...
            >
              <template #label="{ lang }">
                <translate :key="lang"
                  >Dropbox Generated Access Token</translate
                >
              </template>
              <template #description="{ lang }">
                <a
                ...
                >
                  <translate :key="lang"
                    >Learn More about Dropbox Auth Tokens</translate
                  >
                </a>
              </template>
            </b-wrapped-form-group>
