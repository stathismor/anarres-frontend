        ...
        <b-form-fieldset>
          <b-form-row>
            ...
            >
              ...
              <template #description="{ lang }">
                <translate :key="lang"
                  ...
                  extension for file type you wish to use.</translate
                >
                <br />
                <strong>
                  <translate :key="lang + '2'"
                    >Supported file formats:</translate
                  >
                </strong>
                <br />
                <ul class="m-0">
                  ...
                  <li>
                    .tzst (
                    <translate :key="lang + 'zstd'"
                      >ZStandard compression</translate
                    >
                    )
                  </li>
                </ul>
            ...
            >
              ...
              <template #description="{ lang }">
                <translate :key="lang"
                  >This will produce a significantly smaller backup, but you
                  should make sure to back up your media elsewhere. Note that
                  only locally stored media will be backed up.</translate
                >
              </template>
            </b-wrapped-form-checkbox>
          </b-form-row>
