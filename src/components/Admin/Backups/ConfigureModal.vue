    ...
    <b-form-fieldset>
      <b-form-row class="mb-3">
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Enable to have AzuraCast automatically run nightly backups at the
              time specified.</translate
            >
          </template>
        </b-wrapped-form-checkbox>
      </b-form-row>
      ...
      <b-form-row v-if="$v.form.backup_enabled.$model">
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >If the end time is before the start time, the playlist will play
              overnight.</translate
            >
          </template>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Excluding media from automated backups will save space, but you
              should make sure to back up your media elsewhere. Note that only
              locally stored media will be backed up.</translate
            >
          </template>
        </b-wrapped-form-checkbox>
        ...
        <b-wrapped-form-group
          ...
          :field="$v.form.backup_keep_copies"
          input-type="number"
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Copies older than the specified number of days will automatically
              be deleted. Set to zero to disable automatic deletion.</translate
            >
          </template>
        </b-wrapped-form-group>
