      ...
      <b-form-row>
        <b-form-group class="col-md-6" label-for="media_file">
          ...
          <template #description>
            <translate key="media_file_desc"
              >Podcast media should be in the MP3 or M4A (AAC) format for the
              greatest compatibility.</translate
            >
          </template>
        ...
        <b-form-group class="col-md-6">
          ...
          <div v-else>
            <translate key="no_existing_media"
              >There is no existing media associated with this
              episode.</translate
            >
          </div>
        </b-form-group>
...
export default {
  ...
  computed: {
    ...
    targetUrl() {
      return this.editMediaUrl ? this.editMediaUrl : this.newMediaUrl;
    },
  },
  methods: {
