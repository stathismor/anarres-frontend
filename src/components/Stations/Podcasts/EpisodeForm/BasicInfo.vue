      ...
      <b-form-row>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >Typically a website with content about the episode.</translate
            >
          </template>
        </b-wrapped-form-group>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >The description of the episode. The typical maximum amount of
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >The date when the episode should be published.</translate
            >
          </template>
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >The time when the episode should be published (according to the
              stations timezone).</translate
            >
          </template>
          <template #default="props">
            <b-form-timepicker
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              ...
              Podcasts territories.</translate
            >
          </template>
        </b-wrapped-form-checkbox>
      </b-form-row>
