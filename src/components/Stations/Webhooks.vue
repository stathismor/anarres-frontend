    ...
    <b-card no-body>
      ...
      <info-card>
        <translate key="lang_info_card"
          >Web hooks let you connect to external web services and broadcast
          changes to your station to them.</translate
        >
      </info-card>
...
export default {
  ...
  methods: {
    ...
    getToggleVariant(record) {
      return record.is_enabled ? 'warning' : 'success';
    },
    getWebhookName(key) {
