<template>
  <div>
    <b-card no-body>
      ...
      <info-card>
        <p class="card-text">
          <translate key="lang_card_info"
            >Mount points are how listeners connect and listen to your station.
            Each mount point can be a different audio format or quality. Using
            mount points, you can set up a high-quality stream for broadband
            listeners and a mobile stream for phone users.</translate
          >
        </p>
      </info-card>
