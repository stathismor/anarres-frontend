    ...
    <template v-if="enablePublicPage">
      <div class="card-header bg-primary-dark">
        <h3 class="card-title">
          ...
          <small
            ...
            key="lang_profile_public_enabled"
            v-translate
            >Enabled</small
          >
        </h3>
      ...
      <table class="table table-striped table-responsive-md mb-0">
        ...
        <tbody>
          ...
          <tr v-if="enableOnDemand">
            <td key="lang_profile_on_demand_media" v-translate>
              On-Demand Media
            </td>
            <td>
      ...
      <div class="card-actions" v-if="userCanManageProfile">
        ...
        <a
          ...
          :data-confirm-title="langDisablePublicPages"
    ...
    <template v-else>
      <div class="card-header bg-primary-dark">
        <h3 class="card-title">
          ...
          <small
            ...
            key="lang_profile_public_disabled"
            v-translate
            >Disabled</small
          >
        </h3>
      ...
      <div class="card-actions" v-if="userCanManageProfile">
        <a
          ...
          :data-confirm-title="langEnablePublicPages"
          :href="togglePublicPageUri"
        >
...
export default {
  ...
  computed: {
    ...
    publicPageEmbedCode() {
      return (
        '<iframe src="' +
        this.publicPageEmbedUri +
        '" frameborder="0" allowtransparency="true" style="width: 100%; min-height: 150px; border: 0;"></iframe>'
      );
    },
    publicOnDemandEmbedCode() {
      return (
        '<iframe src="' +
        this.publicOnDemandEmbedUri +
        '" frameborder="0" allowtransparency="true" style="width: 100%; min-height: 400px; border: 0;"></iframe>'
      );
    },
    publicRequestEmbedCode() {
      return (
        '<iframe src="' +
        this.publicRequestEmbedUri +
        '" frameborder="0" allowtransparency="true" style="width: 100%; min-height: 850px; border: 0;"></iframe>'
      );
    },
  },
  methods: {
