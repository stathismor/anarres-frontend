    ...
    <div class="card-header bg-primary-dark">
      <div class="d-flex align-items-center">
        <h3
          ...
          key="lang_profile_nowplaying_onair"
          v-translate
        >
          On the Air
        </h3>
          ...
          <div class="col-md-6">
            <div class="clearfix">
              <h6 style="margin-left: 32px">
                ...
                <translate key="lang_profile_nowplaying_title"
                ...
                <div class="media-body">
                  ...
                  <div v-if="np.now_playing.playlist">
                    <small class="text-muted"
                      ><translate key="lang_profile_nowplaying_playlist"
                        >Playlist</translate
          ...
          <div class="col-md-6">
            <div class="clearfix" v-if="!np.live.is_live && np.playing_next">
              <h6 style="margin-left: 22px">
                ...
                <translate key="profile_nowplaying_playing_next"
                  >Playing Next</translate
                >
              </h6>
  ...
  computed: {
    langListeners() {
      let translated = this.$ngettext(
        '%{listeners} Listener',
        '%{listeners} Listeners',
        this.np.listeners.total
      );
      return this.$gettextInterpolate(translated, {
        listeners: this.np.listeners.total,
      });
    },
    isLiquidsoap() {
