  ...
  >
    <b-row>
      <b-col md="7">
        <b-card class="mb-3" no-body>
          <div class="card-header bg-primary-dark">
            <h2 class="card-title" v-translate key="lang_embed_options">
              Customize
            </h2>
          </div>
          <b-card-body>
      ...
      <b-col md="5">
        <b-card class="mb-3" no-body>
          <div class="card-header bg-primary-dark">
            <h2 class="card-title" v-translate key="lang_embed_code">
              Embed Code
            </h2>
          </div>
          <b-card-body>
    ...
    <b-card class="mb-3" no-body>
      ...
      <b-card-body :body-bg-variant="selectedTheme">
        <iframe
          ...
          :style="{ 'min-height': this.embedHeight }"
        ></iframe>
      </b-card-body>
    </b-card>
  </b-modal>
  ...
  computed: {
    ...
    embedCode() {
      return (
        '<iframe src="' +
        this.embedUrl +
        '" frameborder="0" allowtransparency="true" style="width: 100%; min-height: ' +
        this.embedHeight +
        '; border: 0;"></iframe>'
      );
    },
