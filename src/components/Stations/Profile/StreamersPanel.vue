  ...
  <section class="card mb-4" role="region">
    <template v-if="enableStreamers">
      <div class="card-header bg-primary-dark">
        <h3 class="card-title">
          <translate key="lang_profile_streamers_title"
            >Streamers/DJs</translate
          >
          <small
            class="badge badge-pill badge-success"
            key="lang_profile_streamers_enabled"
            v-translate
            >Enabled</small
          >
        </h3>
      ...
      >
        ...
        <a
          ...
          :data-confirm-title="langDisableStreamers"
    ...
    <template v-else>
      <div class="card-header bg-primary-dark">
        <h3 class="card-title">
          ...
          <small
            ...
            key="lang_profile_streamers_disabled"
            v-translate
            >Disabled</small
          >
        </h3>
      ...
      <div class="card-actions" v-if="userCanManageProfile">
        <a
          ...
          :data-confirm-title="langEnableStreamers"
          :href="streamersToggleUri"
        >
