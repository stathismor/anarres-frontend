<template>
  <div class="row" id="profile">
    <div class="col-lg-7">
      ...
      <div
        class="row"
        v-if="stationSupportsRequests || stationSupportsStreamers"
      >
