<template>
  <form class="form vue-form" @submit.prevent="submit">
    <section class="card" role="region">
      ...
      <info-card>
        <p class="card-text">
          <translate key="lang_ls_config_1"
            >Using this page, you can customize several sections of the
            Liquidsoap configuration. This allows you to add advanced
            functionality to your station's AutoDJ.</translate
          >
        </p>
        <p class="card-text">
          <translate key="lang_ls_config_2"
            >The editable text boxes are areas where you can insert custom
            configuration code. The non-editable sections are automatically
            generated by AzuraCast.</translate
          >
        </p>
        <p class="card-text">
          <translate key="lang_ls_config_3"
            >This is an advanced feature and custom code is not officially
            supported by AzuraCast. You may break your station by adding custom
            code, but removing it should fix any issues.</translate
          >
        </p>
      </info-card>
        ...
        <div class="card-body">
          ...
          >
            <b-wrapped-form-group
              v-if="row.is_field"
              :field="$v.form[row.field_name]"
              :id="'form_edit_' + row.field_name"
              input-type="textarea"
              :input-attrs="{
                class: 'text-preformatted mb-3',
                spellcheck: 'false',
                style: 'height: 150px;',
              }"
            >
