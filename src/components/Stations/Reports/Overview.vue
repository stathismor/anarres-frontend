      ...
      <b-overlay variant="card" :show="chartsLoading">
        ...
        <b-tabs pills card lazy v-else>
          ...
          <b-tab :title="langListenersByDayOfWeek">
            <day-of-week-chart
              style="width: 100%"
              :data="chartsData.day_of_week.metrics"
          ...
          <b-tab :title="langListenersByHour">
            <hour-chart
              style="width: 100%"
              :data="chartsData.hourly.metrics"
    ...
    <div class="row">
      <div class="col-sm-6">
        <section class="card mb-3" role="region">
          <div class="card-header bg-primary-dark">
            <h3 class="card-title">
              <translate key="reports_overview_best_songs"
                >Best Performing Songs</translate
              >
              <small>
                <translate key="reports_overview_timeframe"
                  >in the last 48 hours</translate
                >
              </small>
            </h3>
          </div>
          <div class="table-responsive">
            <table class="table table-striped table-condensed table-nopadding">
              ...
              <thead>
                <tr>
                  <th>
                    <translate key="reports_overview_col_change"
                      >Change</translate
                    >
                  </th>
                  <th>
      ...
      <div class="col-sm-6">
        <section class="card mb-3" role="region">
          <div class="card-header bg-primary-dark">
            <h3 class="card-title">
              <translate key="reports_overview_worst_songs"
                >Worst Performing Songs</translate
              >
              <small>
                <translate key="reports_overview_timeframe"
                  >in the last 48 hours</translate
    ...
    <div class="row">
      <div class="col-sm-12">
        <section class="card" role="region">
          <div class="card-header bg-primary-dark">
            <h3 class="card-title">
              <translate key="reports_overview_most_played"
                >Most Played Songs</translate
              >
              <small>
                <translate key="reports_overview_most_played_timeframe"
          ...
          <div class="table-responsive">
            <table class="table table-striped table-condensed table-nopadding">
              ...
              <thead>
                <tr>
                  <th>
                    <translate key="reports_overview_col_plays"
                      >Plays</translate
                    >
                  </th>
                  <th>
