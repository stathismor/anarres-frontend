  ...
  data() {
    return {
      fields: [
        ...
        {
          key: 'length',
          label: this.$gettext('Length Text'),
          visible: false,
          selectable: true,
          sortable: false,
        },
        {
          key: 'playlists',
          label: this.$gettext('Playlist(s)'),
          selectable: true,
          sortable: false,
        },
        {
          key: 'delta_positive',
          label: 'Δ ' + this.$gettext('Joins'),
          selectable: true,
          sortable: true,
        },
        {
          key: 'delta_negative',
          label: 'Δ ' + this.$gettext('Losses'),
          selectable: true,
          sortable: true,
        },
        {
          key: 'delta_total',
          label: 'Δ ' + this.$gettext('Total'),
          selectable: true,
          sortable: true,
        },
        {
          key: 'num_plays',
          label: this.$gettext('Num Plays'),
          selectable: true,
          sortable: true,
        },
        {
          key: 'percent_plays',
          label: this.$gettext('Play %'),
          selectable: true,
          sortable: false,
        },
        {
          key: 'ratio',
          label: this.$gettext('Ratio'),
          selectable: true,
          sortable: false,
        },
      ],
