      ...
      <div class="card">
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="flex-shrink">
              ...
              >
                ...
                <translate key="lang_download_csv_button"
                ...
                <template #input="datePicker">
                  ...
                  >
                    ...
                    <template v-if="isLive">
                      <translate key="lang_live_listeners"
                        >Live Listeners</translate
                      >
                    </template>
                    <template v-else>
        ...
        <div>
          <div class="card-body row">
            <div class="col-md-4">
              <h5>
                <translate key="lang_unique_listeners"
                  >Unique Listeners</translate
                >
                <br />
                <small>
                  <translate key="lang_for_selected_period"
                    >for selected period</translate
                  >
                </small>
              </h5>
          ...
          >
            ...
            <template #cell(user_agent)="row">
              ...
              <span v-else>
                ...
                <span class="sr-only">
                  <translate key="lang_device_desktop"
                    >Desktop Device</translate
                  >
                </span>
              </span>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      fields: [
        ...
        {
          key: 'time_sec',
          label: this.$gettext('Time (sec)'),
          sortable: false,
        },
        {
          key: 'user_agent',
          isRowHeader: true,
          label: this.$gettext('User Agent'),
          sortable: false,
        },
  ...
  computed: {
    ...
    dateRanges() {
      let ranges = {};
      ranges[this.$gettext('Live Listeners')] = [this.liveTime, this.liveTime];
    ...
    isLive() {
      return DateTime.fromJSDate(this.liveTime).equals(
  ...
  methods: {
    ...
    updateListeners() {
      ...
      this.$wrapWithLoading(this.axios.get(this.apiUrl, { params: params }))
        .then((resp) => {
