    ...
    <b-form-row>
      ...
      >
        ...
        <template #description v-if="isEditMode">
          <translate key="lang_edit_form_password_desc"
            >Leave blank to use the current password.</translate
          >
        </template>
      </b-wrapped-form-group>
      ...
      >
        ...
        <template #description="{ lang }">
          <translate :key="lang"
            >Optionally supply SSH public keys this user can use to connect
            instead of a password. Enter one key per line.</translate
          >
        </template>
      </b-wrapped-form-group>
    </b-form-row>
