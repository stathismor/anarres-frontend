<template>
  <b-tab :title="title">
    <b-form-group>
      <template #label>
        <translate key="lang_twitter_instructions_hdr"
          >Twitter Account Details</translate
        >
      </template>

      <p class="card-text">
        <translate key="lang_twitter_instructions_1"
          >Steps for configuring a Twitter application:</translate
        >
      </p>
      <ul>
        <li>
          <translate key="lang_twitter_instructions_1"
            >Create a new app on the Twitter Applications site. Use this
            installation's base URL as the application URL.</translate
          >
          <br />
          <a href="https://developer.twitter.com/en/apps" target="_blank">
            <translate key="lang_twitter_instructions_url"
              >Twitter Applications</translate
            >
          </a>
        </li>
        <li>
          <translate key="lang_twitter_instructions_2"
            >In the newly created application, click the "Keys and Access
            Tokens" tab.</translate
          >
        </li>
        <li>
          <translate key="lang_twitter_instructions_3"
            >At the bottom of the page, click "Create my access
            token".</translate
          >
        </li>
      </ul>
      <p class="card-text">
        <translate key="lang_twitter_instructions_4"
          >Once these steps are completed, enter the information from the "Keys
          and Access Tokens" page into the fields below.</translate
        >
      </p>
    </b-form-group>
