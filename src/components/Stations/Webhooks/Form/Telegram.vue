  ...
  <b-tab :title="title">
    <b-form-group>
      <b-form-row>
        ...
        >
          <template #label="{ lang }">
            <translate :key="lang">Bot Token</translate>
          </template>
          <template #description="{ lang }">
            <a href="https://core.telegram.org/bots#botfather" target="_blank">
              <translate :key="lang"
                >See the Telegram Documentation for more details.</translate
              >
            </a>
          </template>
        </b-wrapped-form-group>
        ...
        >
          <template #label="{ lang }">
            <translate :key="lang">Chat ID</translate>
          </template>
          <template #description="{ lang }">
            <translate :key="lang"
              >Unique identifier for the target chat or username of the target
              channel (in the format @channelusername).</translate
            >
          </template>
        </b-wrapped-form-group>
        ...
        >
          <template #label="{ lang }">
            <translate :key="lang">Custom API Base URL</translate>
          </template>
          <template #description="{ lang }">
            <translate :key="lang"
              >Leave blank to use the default Telegram API URL
    ...
    <b-form-group>
      <b-form-row>
        ...
        >
          <template #label="{ lang }">
            <translate :key="lang">Message parsing mode</translate>
          </template>
          <template #description="{ lang }">
            <a
