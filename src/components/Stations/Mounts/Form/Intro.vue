      ...
      <b-form-row>
        <b-form-group class="col-md-6" label-for="intro_file">
          ...
          <template #description>
            <translate key="intro_file_desc"
              >This introduction file should exactly match the bitrate and
              format of the mount point itself.</translate
            >
          </template>

          <flow-upload
            :target-url="targetUrl"
            :valid-mime-types="acceptMimeTypes"
        ...
        <b-form-group class="col-md-6">
          ...
          <div v-else>
            <translate key="no_existing_intro"
              >There is no existing intro file associated with this mount
              point.</translate
            >
          </div>
        </b-form-group>
...
export default {
  ...
  computed: {
    ...
    targetUrl() {
      return this.editIntroUrl ? this.editIntroUrl : this.newIntroUrl;
    },
  },
  methods: {
