    ...
    <b-form-group>
      <b-form-row class="mb-3">
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >You can set a custom URL for this stream that AzuraCast will use
              when referring to it. Leave empty to use the default
              value.</translate
            >
          </template>
        </b-wrapped-form-group>
      ...
      <b-form-row v-if="isIcecast">
        ...
        >
          ...
          <template #description="{ lang }">
            <translate :key="lang"
              >You can include any special mount point settings here, in either
              JSON { key: 'value' } format or XML
