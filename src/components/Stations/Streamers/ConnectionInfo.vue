<template>
  <div class="card">
    <div class="card-header bg-primary-dark">
      <h2 class="card-title">
        <translate key="lang_connection_info_hdr"
          >Connection Information</translate
        >
      </h2>
    </div>
    <div class="card-body">
      ...
      <dl>
        ...
        <dd v-if="connectionInfo.ip">
          <translate key="lang_connection_ip"
            >You may need to connect directly via your IP address:</translate
          >
        ...
        <dd>
          <code>{{ connectionInfo.streamPort }}</code>
        </dd>
        ...
        <dd>
          <code>{{ connectionInfo.djMountPoint }}</code>
        </dd>
      </dl>
    </div>
    <div class="card-body">
      <h3 class="card-subtitle mt-0">
        <translate key="lang_connection_shoutcast_hdr"
          >SHOUTcast Clients</translate
        >
      </h3>
      <dl>
        <dt class="mb-1">
        ...
        <dd>
          <translate key="lang_connection_info_legacy"
            >For some clients, use port:</translate
          >
