<template>
  <b-tab :title="langTabTitle">
    <b-form-group v-if="scheduleItems.length === 0">
      ...
      <p>
        <translate key="lang_schedule_not_scheduled_desc"
          >This streamer is not scheduled to play at any times.</translate
        >
      </p>
    </b-form-group>
    ...
    >
      <div class="card-header bg-primary-dark d-flex align-items-center">
        <div class="flex-fill">
          <h2 class="card-title">
            <translate
              :key="'lang_scheduled_time_' + index"
          ...
          <b-form-row>
            ...
            >
              ...
              <template #description="{ lang }">
                <translate :key="lang"
                  >If the end time is before the start time, the schedule entry
                  will continue overnight.</translate
                >
              </template>
              <template #default="props">
                <playlist-time
