  ...
  <div :id="id" style="display: contents">
    <div class="datatable-toolbar-top card-body" v-if="showToolbar">
      <b-row class="align-items-center mb-2">
        ...
        <b-col xl="6" md="6" sm="12" v-else> &nbsp; </b-col>
                  ...
                  >
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        v-bind:id="'chk_field_' + field.key"
                      ...
                      <label
                        ...
                        v-bind:for="'chk_field_' + field.key"
                      >
                        {{ field.label }}
                      </label>
                    </div>
        ...
        <template #table-busy>
          <div role="alert" aria-live="polite">
            <div class="text-center my-2">
              <div
                class="progress-circular progress-circular-primary mx-auto mb-3"
              >
