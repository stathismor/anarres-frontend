    ...
    <b-row>
        ...
        <section class="card" role="region">
          ...
          <b-overlay variant="card" :show="securityLoading">
            <b-card-body>
              ...
              <p class="card-text mt-2">
                <translate key="lang_two_factor_info"
                  >Two-factor authentication improves the security of your
                  account by requiring a second one-time access code in addition
                  to your password when you log in.</translate
                >
              </p>
            </b-card-body>
          </b-overlay>
          ...
          <div class="card-actions">
            ...
            >
              ...
              <translate key="lang_btn_change_password"
            ...
            >
              ...
              <translate key="lang_btn_disable_two_factor"
                >Disable Two-Factor</translate
              >
            </b-button>
            <b-button
              v-else
            ...
            >
              <icon icon="lock"></icon>
              <translate key="lang_btn_enable_two_factor"
                >Enable Two-Factor</translate
              >
            </b-button>
          </div>
        </section>
      ...
      <b-col sm="12" md="6" lg="7">
        <b-card no-body>
          ...
          <info-card>
            <translate key="lang_api_keys_info"
              >Use API keys to authenticate with the AzuraCast API using the
              same permissions as your user account.</translate
            >
            <a href="/api" target="_blank">
              <translate key="lang_api_keys_docs_link"
...
export default {
  ...
  methods: {
    relist() {
      ...
      this.$wrapWithLoading(this.axios.get(this.userUrl)).then((resp) => {
        this.user = {
          name: resp.data.name,
      ...
      this.$wrapWithLoading(this.axios.get(this.twoFactorUrl)).then((resp) => {
    ...
    disableTwoFactor() {
      this.$confirmDelete({
        ...
        if (result.value) {
          this.$wrapWithLoading(this.axios.delete(this.twoFactorUrl)).then(
            (resp) => {
