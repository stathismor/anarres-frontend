    ...
    <div class="card">
      <div class="card-body p-4">
        <div class="row mb-2">
          <div class="col-sm">
            <h2 class="card-title mb-0 text-center">
              <translate key="lang_hdr_setup"
                >AzuraCast First-Time Setup</translate
              >
            </h2>
            <h3 class="text-center">
              <small class="text-muted">
                <translate key="lang_subhdr_welcome"
                  >Welcome to AzuraCast!</translate
                >
              </small>
            </h3>
          </div>
        ...
        <div class="row mb-3">
          <div class="col-sm">
            <p class="card-text">
              <translate key="lang_intro_1"
                >Let's get started by creating your Super Administrator
                account.</translate
              >
            </p>
            <p class="card-text">
              <translate key="lang_intro_2"
                >This account will have full access to the system, and you'll
                automatically be logged in to it for the rest of
                setup.</translate
              >
            </p>
          </div>
