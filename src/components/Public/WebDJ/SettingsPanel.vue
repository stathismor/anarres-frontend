  ...
  <div class="card settings">
          ...
          <div class="tab-content mt-1">
            <div class="tab-pane active" id="settings">
              <div class="form-group">
                <label class="mb-2" key="lang_encoder" v-translate
                  >Encoder</label
                >
                <div class="controls">
                  <div
              ...
              <div class="form-group">
                <label class="mb-2" key="lang_dj_creds" v-translate
                  >DJ Credentials</label
                >
              ...
              <div class="form-group mb-0">
                <div class="custom-control custom-checkbox">
                  ...
                  <label for="use_async_worker" class="custom-control-label">
                    <translate key="lang_asynchronous"
                      >Use Asynchronous Worker</translate
                    >
                  </label>
                </div>
              </div>
            ...
            <div class="tab-pane" id="metadata">
              ...
              <div class="form-group">
                <button
                  ...
                  v-on:click="updateMetadata"
                  v-bind:disabled="!isStreaming"
                >
                  <translate key="lang_btn_update_metadata"
                    >Update Metadata</translate
                  >
                </button>
              </div>
            </div>
    ...
    <div class="card-actions">
      ...
      <button
        class="btn"
        v-on:click="cue"
        v-bind:class="{ 'btn-primary': passThrough }"
      >
...
export default {
  ...
  computed: {
    ...
    uri() {
      return (
        'wss://' + this.djUsername + ':' + this.djPassword + '@' + this.baseUri
      );
    },
  },
  props: {
